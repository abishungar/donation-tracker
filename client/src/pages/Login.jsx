...
export default function Login() {
  ...
  const { login } = useAuth();
  React.useEffect(() => { api.get("/auth/config").then(r => { setAppName(r.data?.appName || "Donation Tracker"); if (r.data?.needsFirstMainAdmin) nav("/first-setup", { replace: true }); }).catch(() => {}); }, []);
